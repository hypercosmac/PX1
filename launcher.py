...
apps = [
    ...
    AppIcon(250, 50, 150, 150, (100, 100, 255), "Orchard Nav", ["x-terminal-emulator", "-e", "python3", "hailo/basic_pipelines/detection.py", "--labels-json", "hailo/resources/zaptrack-labels.json", "--hef", "hailo/zaptrack-2024-10-10.hef", "-i", "rpi"]),
